...
class expression{
    ...
    public double expressionEvaluation(String exp){
        ...
        return Double.parseDouble(finalExp.get(0).toString());
    }
    ...
    public void solution(){
        String exp = this.exp;
        double ans = expressionEvaluation(exp);
        System.out.println("The solution of expression is:\nExpression:"+exp+"\nSolution: "+ans);
    }
}
public class S_2 {
